...
class VolunteersControllerTest < ActionController::TestCase
  ...
  test "should create volunteer" do
    assert_difference('Volunteer.count') do
      post :create, volunteer: { about: @volunteer.about, name: @volunteer.name, position: @volunteer.position, twitter: @volunteer.twitter }
    end
  ...
  test "should update volunteer" do
    patch :update, id: @volunteer, volunteer: { about: @volunteer.about, name: @volunteer.name, position: @volunteer.position, twitter: @volunteer.twitter }
    assert_redirected_to volunteer_path(assigns(:volunteer))
  end
